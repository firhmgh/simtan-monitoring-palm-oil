...
<head>
    ...
    <title>Error 503 - Layanan Sedang Dimaintain | SIMTAN PTPN IV</title>
...
<body>
    ...
    <div class="container">
        <div class="glass-card">
            ...
            <!-- Error Title -->
            <h2 class="error-title">Layanan Sedang Dimaintain</h2>

            <!-- Error Description -->
            <p class="error-desc">Kami akan segera kembali.</p>
